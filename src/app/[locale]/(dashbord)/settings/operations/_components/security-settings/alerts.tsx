...
import { SecuritySettings } from "@/shared/lib/types/settings/security-settings";
import { useUpdateSecuritySettings } from "@/shared/lib/hooks/settings/use-update-security-settings";

type ToggleKey = keyof SecuritySettings;

const TOGGLES: ToggleKey[] = ["twoFactorAuth"];

interface SecurityFormProps {
  initialData: SecuritySettings;
}

export default function SecurityForm({ initialData }: SecurityFormProps) {
  const t = useTranslations("Settings.operations.securitySettings");
