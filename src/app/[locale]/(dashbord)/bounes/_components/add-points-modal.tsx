...
export default function AddPointsModal({
  ...
  const handleSubmit = () => {
    console.log("إضافة نقاط", { userId, userName, points, reason, notes });
    onClose();
  };
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:min-w-[480px] rounded-2xl">
        <DialogHeader>
          <h2 className="my-5 flex  justify-center text-2xl items-center gap-2 text-[#0C6175]">
