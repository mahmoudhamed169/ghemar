...
export default function CustomerFilters() {
  return (
    <div className="flex flex-row items-center gap-4 w-full">
      ...
      <div className="flex flex-row items-center gap-3 w-[500px] shrink-0">
        ...
        <Select defaultValue="">
          <SelectTrigger className="flex-1 !h-[55px] bg-white border border-gray-200 rounded-lg shadow-sm text-right px-3">
            <SelectValue placeholder="الحقيبة الاساسية" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="basic">الحقيبة الاساسية</SelectItem>
